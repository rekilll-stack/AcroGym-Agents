...
function verifyCaption(caption) {
  ...
  if (/\b(free|trial)\b/i.test(text)) issues.push('в подписи запрещённое слово trial/free — первое занятие платное, CTA = Book Your First Class');
